...
const products: Product[] = [
  ...
  },
  {
    ...
    name: 'Men\'s Jeans',
    category: 'casual',
    description: 'Stylish and comfortable Men\'s Jeans ',
    image: '/products/mens_jeans_1.webp',
    minOrder: 16,
    price: "₹330/per piece",
    tags: ['casual', 'jeans'],
    sizes: '28 to 36'
  ...
  {
    id: 'p3',
    name: 'Wedding Suit Men',
    category: 'wedding',
    description: 'Suit for wedding and party settings',
    image: '/products/formal_suit_men.jpg',
    minOrder: 5,
    price: "₹2700/per piece",
    tags: ['suit', 'wedding'],
    sizes: 'S to XL'
  },
  {
    ...
    image: '/products/men_tshirt_1.png',
    minOrder: 20,
    price: "₹240/per piece",
    tags: ['thsirt', 'casual', 'everyday'],
    sizes: '38 to 44'
  },
  {
    id: 'p5',
